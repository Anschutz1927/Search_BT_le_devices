...
public class ServicesAdapter
        extends RecyclerView.Adapter<ServicesAdapter.Holder> {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        holder.mServiceNameTv.setText(mServices.get(position)
                .getUuid().toString());
        Context ctx = holder.itemView.getContext();
        holder.itemView
                .setOnClickListener(getOnClickListener(ctx, position));
    }
        ...
        if (ctx instanceof DeviceServicesActivity) {
            return new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((DeviceServicesActivity) ctx)
                            .readCharacteristics(mServices.get(position));
                }
            };
        }
        else {
    ...
    static class Holder extends RecyclerView.ViewHolder {
        ...
        Holder(View itemView) {
            super(itemView);
            mServiceNameTv = (TextView) itemView
