...
//    private static final byte[] DEFAULT_VALUE = {(byte) 0, (byte) 1};
    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        holder.mCharacsUuidTv.setText(mCharacteristics.get(position).getUuid().toString());
        ...
        holder.mBtnSendIb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mCharacteristics.get(pos).setValue(DEFAULT_VALUE)) {
                    Toast.makeText(holder.itemView.getContext(),"Value not setted.",
    ...
    static class Holder extends RecyclerView.ViewHolder {
        ...
        Holder(View itemView) {
            super(itemView);
            mCharacsUuidTv = (TextView) itemView.findViewById(R.id.tv_characteristic);
