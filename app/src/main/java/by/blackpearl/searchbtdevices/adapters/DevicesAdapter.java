...
public class DevicesAdapter extends RecyclerView.Adapter<DevicesAdapter.Holder> {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.mDeviceSignalLevel.setText(mBtDevicesSignal.get(position) + " dB");
    ...
    static class Holder extends RecyclerView.ViewHolder {
        ...
        Holder(View itemView) {
            ...
            mDeviceMac = (TextView) itemView.findViewById(R.id.tv_device_mac);
            mDeviceSignalLevel = (TextView) itemView.findViewById(R.id.tv_device_signal_level);
        }
    }
