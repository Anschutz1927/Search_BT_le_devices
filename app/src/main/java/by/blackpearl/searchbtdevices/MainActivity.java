...
//            finish();
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            mSettings = new ScanSettings.Builder().setScanMode(ScanSettings.SCAN_MODE_LOW_LATENCY)
                    .build();
        }
        else {
...
//                finish();
    ...
    private DevicesAdapter.Callback getDeviceAdapterCallback() {
        return new DevicesAdapter.Callback() {
            ...
            public void onDeviceClicked(BluetoothDevice device) {
                Intent activityIntent = new Intent(MainActivity.this, DeviceServicesActivity.class);
                activityIntent.putExtra(DeviceServicesActivity.BT_ADDRESS, device.getAddress());
        ...
        return new BluetoothAdapter.LeScanCallback() {
            ...
            public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
                if (device != null && !mDevicesAdapter.isDeviceContainsInArray(device)) {
                    ...
                    Toast.makeText(MainActivity.this, "Found device: null", Toast.LENGTH_SHORT)
                            .show();
                }
            }
        };
    ...
    private ScanCallback getScanCallback() {
        return new ScanCallback() {
            ...
            public void onScanResult(int callbackType, ScanResult result) {
                ...
                if (result != null && !mDevicesAdapter.isDeviceContainsInArray(result.getDevice())) {
    ...
    private void startSearchBtLeDevices() {
        ...
        if (Build.VERSION.SDK_INT < 21 && Build.VERSION.SDK_INT >= 18) {
            ...
            mBtAdapter.getBluetoothLeScanner().startScan(mFilterList, mSettings, mScanCallback);
        }
    ...
    private class SaverHelper {
        ...
        SaverHelper (DevicesAdapter da, ScanCallback sck, BluetoothAdapter.LeScanCallback lesck) {
            savedAdapter = da;
            savedScanClbck = sck;
